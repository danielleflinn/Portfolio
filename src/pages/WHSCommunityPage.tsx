...
export function WHSCommunityPage() {
  return <div className="w-full min-h-screen bg-white">
      ...
      <main className="w-full" style={{ paddingTop: '60px' }}>
        ...
        timeline="6 months" role="Product Designer" methods={['UI/UX Design', 'Discovery research', 'User surveys', 'User interviews', 'Gamification map', 'Wireframing', 'Usability testing', 'Sketch']} impact="Launched a 0 to 1 social wellness product that expanded business offerings" image="/community-cover.png" />
