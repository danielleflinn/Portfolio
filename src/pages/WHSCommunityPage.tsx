  ...
  return <div className="w-full min-h-screen bg-white">
      ...
      <main className="w-full" style={{ paddingTop: '60px' }}>
        ...
        <p className="text-gray-700 max-w-2xl">
          ...
          <div>
            <img src="/whs-wireframes.png" alt="Wireframes showing the information architecture and key screens" className="w-full h-auto rounded-lg overflow-hidden shadow-md" />
          </div>
        </CaseStudySection>
          ...
          <div>
            <div className="mb-8">
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1">
                  <img src="/whs-low-fidelity-testing.png" alt="Low-fidelity wireframes being tested with users" className="w-full h-auto rounded-lg overflow-hidden shadow-md" />
                </div>
              </div>
            </div>
            <div className="mb-8">
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1">
                  <img src="/whs-high-fidelity-testing.png" alt="High-fidelity prototype being tested with users" className="w-full h-auto rounded-lg overflow-hidden shadow-md" />
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1">
                  <img src="/whs-mobile-testing.png" alt="Mobile prototype being tested with users" className="w-full h-auto rounded-lg overflow-hidden shadow-md" />
                </div>
              </div>
            </div>
          </div>
        ...
        <CaseStudySection header="Design Solution" subheader="An intuitive social wellbeing experience built on common interactions and responsive components" columns={1} id="design-solution">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              <div>
                <img src="/whs-main-feed.png" alt="Main feed interface" className="w-full h-auto rounded-lg overflow-hidden shadow-md mb-2" />
                <p className="text-sm text-gray-600 text-center">Main feed</p>
              </div>
              <div>
                <img src="/whs-discover-groups.png" alt="Discover groups interface" className="w-full h-auto rounded-lg overflow-hidden shadow-md mb-2" />
                <p className="text-sm text-gray-600 text-center">Discover groups</p>
              </div>
              <div>
                <img src="/whs-main-groups-page.png" alt="Main groups page interface" className="w-full h-auto rounded-lg overflow-hidden shadow-md mb-2" />
                <p className="text-sm text-gray-600 text-center">Main groups page</p>
              </div>
              <div>
                <img src="/whs-wellness-advocate-page.png" alt="Wellness advocate page interface" className="w-full h-auto rounded-lg overflow-hidden shadow-md mb-2" />
                <p className="text-sm text-gray-600 text-center">Wellness advocate page</p>
              </div>
              <div>
                <img src="/whs-my-activity-filter.png" alt="My Activity filter interface" className="w-full h-auto rounded-lg overflow-hidden shadow-md mb-2" />
                <p className="text-sm text-gray-600 text-center">My Activity filter</p>
              </div>
              <div>
                <img src="/whs-create-post.png" alt="Create a post interface" className="w-full h-auto rounded-lg overflow-hidden shadow-md mb-2" />
