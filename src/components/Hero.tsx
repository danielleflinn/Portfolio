      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center">
        ...
        delay: 0.2
          ...
          <svg width="403" height="424" viewBox="0 0 403 424" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-md">
            ...
            <path d="M187 318H232" stroke="#4B5563" strokeWidth="0.5" />
            <path d="M187 312H232" stroke="#4B5563" strokeWidth="0.5" />
            <path d="M187 324H232" stroke="#4B5563" strokeWidth="0.5" />
            <path d="M187 330H232" stroke="#4B5563" strokeWidth="0.5" />
            <path d="M187 336H232" stroke="#4B5563" strokeWidth="0.5" />
