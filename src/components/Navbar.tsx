  ...
  return <nav className="w-full bg-[#FFFAF5] py-4 px-6 md:px-12 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="flex-end">
          <Link to="/" className="text-[#F4632F] font-bold text-2xl">
            Danielle Flinn
          </Link>
      ...
      {isMenuOpen && <div className="md:hidden absolute top-16 left-0 right-0 bg-[#FFFAF5] shadow-md py-4 px-6 flex flex-col space-y-4">
          <Link to="/" className="text-gray-700 hover:text-[#F4632F] transition-colors" onClick={toggleMenu}>
            My work
          </Link>
          <Link to="/about" className="text-gray-700 hover:text-[#F4632F] transition-colors" onClick={toggleMenu}>
            About
          </Link>
