  ...
  return <section id="contact" className="w-full py-16 px-6 md:px-12 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        once: true
          ...
          <a href="mailto:contact@dflinn.com" className="bg-[#F45F2A] hover:bg-[#D94F23] text-black font-semibold tracking-wide px-8 py-4 rounded-lg transition-colors flex items-center justify-center">
