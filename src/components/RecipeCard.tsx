...
export function RecipeCard({
  ...
  return <Link to={pageLink} className="block">
      <motion.div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow flex flex-col md:flex-row cursor-pointer" initial={{
      opacity: 0,
      y: 20
    }} animate={{
      opacity: 1,
      ...
      delay: index * 0.1
        ...
        <div className="p-4 flex-1 flex flex-col">
          ...
          <div className="w-full bg-[#FFFAF5] hover:bg-[#FFE8D9] text-[#C3471D] font-medium py-2 rounded-lg transition-colors border border-[#FFD6C2] text-center">
